...
namespace XLua.CSObjectWrap
{
    ...
    public class EntityWrap 
    {
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_AddEntityAttribute(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.AddEntityAttribute( _name );
        ...
        static int _m_IsInThisAni(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<System.Collections.Generic.List<AnimationData>>(L, 2)) 
                {
                    System.Collections.Generic.List<AnimationData> _animations = (System.Collections.Generic.List<AnimationData>)translator.GetObject(L, 2, typeof(System.Collections.Generic.List<AnimationData>));
                    
                        var gen_ret = gen_to_be_invoked.IsInThisAni( _animations );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        static int _g_get_hurt(RealStatePtr L)
        {
		    try {
                ...
                Entity gen_to_be_invoked = (Entity)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.hurt);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_animationConfig(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Entity gen_to_be_invoked = (Entity)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.animationConfig);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_entityAttribute(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Entity gen_to_be_invoked = (Entity)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.entityAttribute);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_hurt(RealStatePtr L)
        {
		    try {
                ...
                Entity gen_to_be_invoked = (Entity)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.hurt = LuaAPI.xlua_tointeger(L, 2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_animationConfig(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Entity gen_to_be_invoked = (Entity)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.animationConfig = (AnimationConfig)translator.GetObject(L, 2, typeof(AnimationConfig));
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_entityAttribute(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Entity gen_to_be_invoked = (Entity)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.entityAttribute = (EntityAttribute)translator.GetObject(L, 2, typeof(EntityAttribute));
